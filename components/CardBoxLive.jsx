...
function CardBoxLive() {
  return (
        ...
        <div className="d-flex justify-content-between w-100 pt-2 px-3 ">
            <div className="ps-2">
              <Image className="mx-1" src={wallHerb} alt="wallHerb"/>
              <Image className="mx-1" src={Live} alt="wallHerb"/>
              <Image src={LiveQMark} alt="wallHerb"/>
            </div>
            <div className="">
            <Image className=" mx-1 " src={pause} alt="wallHerb"/>
            <Image src={rewind} alt="wallHerb"/>
            </div>
        </div>
                  ...
                  {slide1.map((item, index) => {
                    return (<div key={index} className="w-100 mt-2 live-cards   ">
                      <div className="card d-flex justify-content-center  mx-3 card-cont" key={index} >
                        <Image src={item.img} className="align-self-center h-50 pt-1" alt="..." />
