...
function Securemobcards() {
    return (
        <>
            ...
            <div className='sec-Rewards-values-shown w-100  pt-3 px-2 text-start' style={{border:"1px solid #CCCCCC"}} ><p className='secure-font-setup-for-p' > <Image src={blgmob1} alt="" />  Rewards values shown in US Dollars</p>
                </div>
