  ...
  return (
    <>
      <div className='align-item-center container-lg mt-5'>
        {/* image one */}
        <div>
          <Image src={pd1} alt="" style={{ width: "100%" }} />
        ...
        {/* image Two */}
        <div>
          <Image src={pd2} alt="" style={{ width: "100%" }} />
        </div>

        {/* image three */}
        <div>
          <Image src={pd3} alt="" style={{ width: "100%" }} />
        </div>
      </div>
      ...
      <div className='quality-and-safely-section '>
        <div>
          <Image src={pd4} alt="" style={{ width: "100%" }} />
        </div>
      ...
      <div className='mt-5 text-center container-lg'>
             <Image src={pd5} alt="" style={{width : "100%"}}/>
      </div>
