                ...
                <div className='border border-2  p-2 '>
                  ...
                  <div className='d-flex  mb-2'>
                    <div className='text-center' >
                      <img src={Product1} className='img-fluid d-block  w-75 mx-auto' alt='product' />
                      <span className='green-text' >110 referals</span>
                    </div>
                    <div className='text-center'>
                      <img src={Product2} className='img-fluid d-block w-75 mx-auto' alt='product' />
                      <span className='green-text' >110 referals</span>
                    </div>
                  ...
                  <div className=''>
                    <div className='d-flex align-items-center justify-content-between py-1'>
                      ...
                      <div className='d-flex my-auto  align-items-center'>
                        ...
                        <img src={shareIcon} alt='share' className='my-auto ms-1'/>
                      </div>
                    </div>
                    <div className='d-flex align-items-center  justify-content-between py-1'>
                      <button className='btn border  rounded-pill border-1 py-1 bg-transparent'>Supplements</button>
