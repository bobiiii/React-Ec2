                ...
                <div className='sales-products container-fluid mt-5'>
                    <div className="card " style={{ width: "18rem" }}>
                        ...
                        <div className="card-body  ">
                            ...
                            <p>Expires 5/31/23 at 11:59:59 PM PT</p>
                            <p className="card-text">Refer anyone to shop the iHerb App from
                ...
                <div className='brand-off-week d-flex justify-content-center container-fluid'>
                    <div className='mt-4 justify-content-center'>
                        ...
                        <div className='View-all-Brands'>
                            <h6 className='text-center'> <a href="" className="text-decoration-none text-dark"> View all Brands of the Week </a> </h6>
                        </div>
                    </div>
