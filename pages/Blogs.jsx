            ...
            <section className='container-fluid    blog-section-for-desktop' >
                <nav className="navbar navbar-expand-lg navbar-light NAVBAR2">
                    <div className="container-fluid">
                        ...
                        <a className="navbar-brand" href="#"><Image src={logoImage} alt="" /></a>
                        <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                            ...
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ul-item-style">
                                <li className="nav-item ">
                                    <a className="nav-link active " aria-current="page" href="#"> <Image src={blgnav1} alt="" className="mb-1" style={{height:"20px"}} />WELLNESS</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link active" aria-current="page" href="#"><Image className="mb-1" src={blgnav2} alt="" style={{height:"20px"}} /> FITNESS</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link active" aria-current="page" href="#"> <Image src={blgnav3} className="mb-1" alt="" style={{height:"20px"}} /> NUTRATION</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link active" aria-current="page" href="#"> <Image src={blgnav1} className="mb-1" alt="" style={{height:"20px"}} /> BEAUTY</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className='blog-hero-section container-fluid'>
                    <div>
                        ...
                        <p> <span className='text-success'>May 2024</span>  |  <Image className="mb-1" src={view} alt="" /> 218 Views </p>
                ...
                <div className='container-fluid blog-products-section'>
                    <div className="card" style={{ width: '20rem', background: "#F5F5F5" }}>
                        <Image src={blogpro} className="card-img-top" alt="..." />
                        <div className="card-body">
                            <p style={{
                                ...
                                fontSize: '14px',
                                lineHeight: '15px',
                            }}> <Image className="mb-1" src={blgnav1} alt="" /> Supplements</p>
                            <h5 className="card-title">7 Evidence-Based Ways Liquid
                                Chlorophyll Can Benefit Health </h5>
                            <p>Oct 2021 |
                            <Image className="mb-1 ms-1" src={view} alt="" /> 526,015 Views</p>
                    ...
                    <div className='blog-user-section-cards'>
                        ...
                        <div className="card p-3 py-4 border-0" style={{ width: "15rem" }}>
                            <div className="text-center">
                                <Image src={user1} width="100" className="rounded-circle" />
                            </div>
    ...
    <div className="accordion-body" style={{ backgroundColor: "transparent" }}>
      <a href="" className="text-decoration-none text-dark">
        heello
                ...
                <div className="mt-4 The-Best-Natural-Remedies-for-mobile">
                    ...
                    <div className="The-Best-Natural-Remedies-for-mobile-link-views">
                        ...
                        <div ><a href="" className="text-decoration-none" style={{ color: "#EF6C00" }}>Share
                            ...
                            <Image className="ms-1" src={vectorShare} alt="" style={{ width: "12px", height: "12px" }} />
                        </a></div>
                        <div >
                            <Image src={view} alt="" />
                ...
                <div >
                    <Image src={blgspace} style={{ width: "100%" }} alt="" />
                </div>
            ...
            <a href="" className="text-decoration-none text-dark">
                ...
                <div className="blog-last-card-for-mobile mt-4">
                    ...
                    <div className="card " style={{ width: "18rem" }}>
                        <Image src={Blog} className="card-img-top" alt="..." />
