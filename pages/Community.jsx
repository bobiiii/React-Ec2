        ...
        <>
            <section style={{ background: "#FFFFFF" }}>
                ...
                <div className='container-fluid px-2 d-flex  align-items-center'>
                    <Image src={comone} alt="" className="d-none d-md-block" style={{ width: "40px", height: "40px", textAlign: "center" }} />
                    ...
                    <div className='Latest-happy-customers-card d-flex flex-nowrap flex-md-wrap flex-lg-wrap overflow-scroll justify-content-md-center  container-fluid'>
                        ...
                        <div className="  p-3 py-4 border-0 w-auto  ">
                            <div className="text-center leadership-user">
                                <Image src={comtwo} width="100" className="rounded-circle" style={{ width: "116px", height: "116px" }} />
                            </div>
...
<div className="  p-3 py-4 border-0 w-auto  ">
                ...
                <div className='container-fluid px-3 Latest-happy-customers  mt-5 '>
                    <Image src={comfour} alt="" className="d-none d-md-block" style={{ width: "40px", height: "40px", textAlign: "center" }} />
                        ...
                        <div className="card p-4 border-0">
                            <div className=" image d-flex flex-column justify-content-center align-items-center">
                                <button className="btn com-user-img">
                                    <Image src={comfive} height="100" width="100" alt="Profile" />
                                </button>
                ...
                <div className='container mt-5 d-none d-md-block '>
                    ...
                    <div className="d-flex ">
                        <Image src={comsix} alt="" className=" mx-2 " style={{ width: "40px", height: "40px", textAlign: "center" }} />
                            ...
                            <div className="row gap-3   justify-content-center  ">
                                <div className="col-lg-5  border border-2 rounded-3 ">
                                    <div className="d-flex align-items-center py-2">
                                        ...
                                        <Image src={Evilbunny} alt="DP" className="px-1" />
                                        <div >
                    ...
                    <div>
                        <Slider {...settings} >
                            <div className="card w-100 py-2   " >
                                <Image src={Evilbunny} className="m-auto w-50" alt="..." />
                                <div className="card-body">
                                    ...
                                    <div className="d-flex justify-content-between justify-content-sm-around ">
                                        <Image src={CommentIcon} alt="start" />
                                        <span>0</span>
                                    </div>
                ...
                <div className='container  Latest-happy-customers '>
                    <Image src={comeight} alt="" style={{ width: "40px", height: "40px", textAlign: "center" }} />
